...
public final class YanYue extends Formation {
	...
	public YanYue(GroupType ct) {		
		...
		if (ct == GroupType.Bro) {
			...
			formMap.put(new Point(2, 2), CreatureType.Bro4);
			formMap.put(new Point(3, 1), CreatureType.Eld); // 老爷爷
			formMap.put(new Point(3, 2), CreatureType.Bro5);
			formMap.put(new Point(4, 1), CreatureType.Bro6);
			formMap.put(new Point(5, 0), CreatureType.Bro7);
		}
		else {
			init(9, 6, 4, 3); // 阵型图所占行列
			// 妖怪的位置
			formMap.put(new Point(0, 5), CreatureType.Mons);
			formMap.put(new Point(1, 3), CreatureType.Mons);
			formMap.put(new Point(1, 4), CreatureType.Mons);
			formMap.put(new Point(2, 2), CreatureType.Mons);
			...
			formMap.put(new Point(3, 2), CreatureType.Mons);		
			formMap.put(new Point(4, 0), CreatureType.Mons);
			formMap.put(new Point(4, 1), CreatureType.Scorp); // 蝎子精
			formMap.put(new Point(4, 2), CreatureType.Snk); // 蛇精
			...
			formMap.put(new Point(7, 3), CreatureType.Mons);
			formMap.put(new Point(7, 4), CreatureType.Mons);
			formMap.put(new Point(8, 5), CreatureType.Mons);
		}
	}
}
